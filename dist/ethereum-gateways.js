...
var EthereumGatewayV1 = /** @class */ (function () {
    ...
    EthereumGatewayV1.prototype.withdrawAsync = function (receipt, overrides) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var signature, tokenAddr, result;
            return tslib_1.__generator(this, function (_a) {
                signature = _1.CryptoUtils.bytesToHexAddr(receipt.oracleSignature);
                tokenAddr = receipt.tokenContract.local.toString();
                switch (receipt.tokenKind) {
                    ...
                    case transfer_gateway_pb_js_1.TransferGatewayTokenKind.ERC20:
                        result = this.contract.functions.withdrawERC20(receipt.tokenAmount.toString(), signature, tokenAddr, overrides);
                        break;
                    case transfer_gateway_pb_js_1.TransferGatewayTokenKind.ERC721:
                        result = this.contract.functions.withdrawERC721(receipt.tokenId.toString(), signature, tokenAddr, overrides);
                        break;
                    case transfer_gateway_pb_js_1.TransferGatewayTokenKind.ERC721X:
                        result = this.contract.functions.withdrawERC721X(receipt.tokenId.toString(), receipt.tokenAmount.toString(), signature, tokenAddr, overrides);
                        break;
                    default:
...
var EthereumGatewayV2 = /** @class */ (function () {
    ...
    EthereumGatewayV2.prototype.withdrawAsync = function (receipt, overrides) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var tokenAddr, validators, hash, _a, vs, rs, ss, valIndexes, result;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        tokenAddr = receipt.tokenContract.local.toString();
                        return [4 /*yield*/, this.vmc.functions.getValidators()];
                    case 1:
                        validators = _b.sent();
                        ...
                        switch (receipt.tokenKind) {
                            ...
                            case transfer_gateway_pb_js_1.TransferGatewayTokenKind.LOOMCOIN:
                            case transfer_gateway_pb_js_1.TransferGatewayTokenKind.ERC20:
                                result = this.contract.functions.withdrawERC20(receipt.tokenAmount.toString(), tokenAddr, valIndexes, vs, rs, ss, overrides);
                                break;
                            case transfer_gateway_pb_js_1.TransferGatewayTokenKind.ERC721:
                                result = this.contract.functions.withdrawERC721(receipt.tokenId.toString(), tokenAddr, valIndexes, vs, rs, ss, overrides);
                                break;
                            case transfer_gateway_pb_js_1.TransferGatewayTokenKind.ERC721X:
                                result = this.contract.functions.withdrawERC721X(receipt.tokenId.toString(), receipt.tokenAmount.toString(), tokenAddr, valIndexes, vs, rs, ss, overrides);
                                break;
                            default:
                                throw new Error('Unsupported token kind ' + receipt.tokenKind);
                        }
