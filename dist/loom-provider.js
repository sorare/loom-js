...
var LoomProvider = /** @class */ (function () {
    ...
    function LoomProvider(client, privateKey, setupMiddlewaresFunction) {
        ...
        this._ethSubscriptions = new Map();
    ...
    LoomProvider.prototype._addDefaultEvents = function () {
        var _this = this;
    ...
    LoomProvider.prototype._addDefaultMethods = function () {
     ...
     */
    LoomProvider.prototype._addLegacyDefaultMethods = function () {
     ...
     */
    LoomProvider.prototype._addWeb3EndpointMethods = function () {
    ...
    LoomProvider.prototype._ethCallSupportedMethod = function (payload) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (result instanceof evm_pb_1.EthBlockHashList) {
                            return [2 /*return*/, result.getEthBlockHashList_asU8().map(function (hash) { return bytesToHexAddrLC(hash); })];
                        }
                        else if (result instanceof evm_pb_1.EthTxHashList) {
                            return [2 /*return*/, result.getEthTxHashList_asU8().map(function (hash) { return bytesToHexAddrLC(hash); })];
                        }
                        else if (result instanceof evm_pb_1.EthFilterLogList) {
                            return [2 /*return*/, result.getEthBlockLogsList().map(function (log) { return _this._createLogResult(log); })];
                        }
                        return [2 /*return*/];
                }
            });
    ...
    LoomProvider.prototype._ethSubscribeLegacy = function (payload) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
    ...
    LoomProvider.prototype._ethSubscribe = function (payload) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var method, params, subscriptionId;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this._subscribed) {
                        ...
                        return [4 /*yield*/, this._client.evmSubscribeAsync(method, params)];
                    case 1:
    ...
    LoomProvider.prototype._ethUnsubscribeLegacy = function (payload) {
        return this._client.evmUnsubscribeAsync(payload.params[0]);
    };
    LoomProvider.prototype._ethUnsubscribe = function (payload) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var subscriptionId, unsubscribeMethod, response;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        subscriptionId = payload.params[0];
                        unsubscribeMethod = payload.params[1] || 'eth_unsubscribe';
                        if (!this._ethSubscriptions.has(subscriptionId)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this._client.sendWeb3MsgAsync(unsubscribeMethod, [subscriptionId])];
                    case 1:
                        response = _a.sent();
                        if (response) {
                    ...
                    case 2: throw new Error("Provider error: Subscription with ID " + subscriptionId + " does not exist.");
                }
            });
        });
    };
    ...
    LoomProvider.prototype._onWebSocketMessage = function (msgEvent) {
        if (this._client.isWeb3EndpointEnabled) {
            ...
            this.notificationCallbacks.forEach(function (callback) { return callback(msgEvent); });
            return;
        }
        var eventArgs = msgEvent;
        if (eventArgs.kind === client_1.ClientEvent.EVMEvent) {
            var JSONRPCResult_1 = {
                jsonrpc: '2.0',
            ...
            log('Socket message arrived', JSON.stringify(JSONRPCResult_1, null, 2));
            this.notificationCallbacks.forEach(function (callback) { return callback(JSONRPCResult_1); });
        }
    };
