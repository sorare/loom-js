    ...
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    tx = _a.sent();
                    t.equal(tx.status === true ? true : tx.status, true, "doEmit should return correct status for " + value);
...
function testLoomProvider(t, useEthEndpoint) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
...
function testWeb3ChildContractEvents(t, useEthEndpoint) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, testLoomProvider(t, useEthEndpoint)];
                case 2:
                    _a.sent();
                    t.end();
                    return [2 /*return*/];
...
tape_1.default('LoomProvider + Web3 + Child contracts events (/query)', function (t) {
    return testWeb3ChildContractEvents(t, false);
});
tape_1.default('LoomProvider + Web3 + Child contracts events (/eth)', function (t) {
    return testWeb3ChildContractEvents(t, true);
});
