...
function testWeb3Middleware(t, useEthEndpoint) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
...
tape_1.default('LoomProvider + Web3 + Middleware (/query)', function (t) { return testWeb3Middleware(t, false); });
tape_1.default('LoomProvider + Web3 + Middleware (/eth)', function (t) { return testWeb3Middleware(t, true); });
