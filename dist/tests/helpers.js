...
exports.getWeb3TestUrls = getWeb3TestUrls;
/**
 ...
 */
function createWeb3TestClient() {
    return new index_1.Client('default', getWeb3TestUrls().wsWriteUrl, getWeb3TestUrls().wsReadUrl);
}
exports.createWeb3TestClient = createWeb3TestClient;
